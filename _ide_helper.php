...
namespace Illuminate\Support\Facades {
    ...
    class Cache {
        ...
        public static function store($name = null)
        {
            ...
            /** @var \Stancl\Tenancy\CacheManager $instance */
         ...
         * @return \Stancl\Tenancy\CacheManager 
         * @static 
         */
...
namespace Illuminate\Routing {
    ...
    class UrlGenerator {
         ...
         * 
         *
         * @see \Stancl\Tenancy\Bootstrappers\FilesystemTenancyBootstrapper::__construct()
         * @param mixed $root
         * @static 
         */
        public static function setAssetRoot($root)
        {
            return \Illuminate\Routing\UrlGenerator::setAssetRoot($root);
        }
