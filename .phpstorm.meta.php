    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Stancl\Tenancy\Contracts\Tenant' => \App\Models\Tenant::class,
            ...
            'cache' => \Stancl\Tenancy\CacheManager::class,
    ...
    override(\config(), map([
            ...
            'database.connections.tenant.search_path' => 'string',
            'database.connections.tenant.sslmode' => 'string',
            ...
            'filesystems.links./Users/brightnkrumah/work/podcast-speedster/public/storage' => 'string',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.tenant.driver','database.connections.tenant.url','database.connections.tenant.host',
'database.connections.tenant.port','database.connections.tenant.database','database.connections.tenant.username','database.connections.tenant.password','database.connections.tenant.charset',
'database.connections.tenant.prefix','database.connections.tenant.prefix_indexes','database.connections.tenant.search_path','database.connections.tenant.sslmode','database.migrations.table',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/brightnkrumah/work/podcast-speedster/public/storage',
...
'tenancy.migration_parameters.--path','tenancy.migration_parameters.--realpath','tenancy.seeder_parameters.--class','hashing.driver','hashing.bcrypt.rounds',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','ide-helper.filename','ide-helper.models_filename',
...
'stancl.tenancy.asset','storage.local',);
